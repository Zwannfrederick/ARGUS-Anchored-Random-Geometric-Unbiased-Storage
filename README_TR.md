...
>
> Hesaplama anında, özel Triton JIT çekirdekleri yardımıyla verileri doğrudan GPU SRAM'inde yüksek hassasiyetli **FP16 geçici tensörlere** dönüştürür ve ölçeklendirilmiş iç çarpım attention işlemini bu aşamada gerçekleştirir. Bu sayede modelin orijinal attention dağılımı ve anlamsal kalitesinin korunması hedeflenir; bozulma en aza indirilir.
...
*   **Sonuç:** 4GB dizüstü ekran kartınızda tamamen kararlı, kesintisiz ve uzun bağlamlı sohbetlerin keyfini çıkarırsınız. ARGUS, kısıtlı değerlendirme kurulumumuzda yüksek zamansal attention lokalitesi yeniden kullanım oranları sunar ve kısıtlı VRAM bütçeleri altında bellek tahsisi kaynaklı OOM arızalarını önemli ölçüde azaltır.
